...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/10/27 18:09:33 by cskipjac          #+#    #+#              #
#    Updated: 2021/11/15 17:37:31 by cskipjac         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME	=	libft.a

LIST	=	ft_strtrim.c ft_isalnum.c ft_isprint.c ft_memcpy.c ft_putendl_fd.c ft_strchr.c ft_strlcat.c ft_strncmp.c ft_substr.c\
		...
		ft_calloc.c ft_isdigit.c ft_memcmp.c ft_putchar_fd.c ft_split.c ft_strjoin.c ft_strmapi.c 
